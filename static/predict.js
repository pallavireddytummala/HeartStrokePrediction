...
var inputglu = document.getElementById('glu');
...
function validateName()
{
    ...
    {
        inputname.innerHTML = '<span class="wrong">✖️</i>';
        return false;
    }
    if(name.match(/^[A-Za-z]*\s*/)) //if input is a string
    {
        inputname.innerHTML = '<i class="check fa fa-check">✔️</i>';
        return true;
    } 
...
function validateAge()
{
    ...
    if(age.length == 0)
    {
        inputage.innerHTML = '<span class="wrong">✖️</i>';
        return false;
    }
    //if input is not an number 
    if(isNaN(age) || (age<0) || (age>110))
    {
        inputage.innerHTML = '<span class="wrong">✖️</span>';
        return false;
    } 
    inputage.innerHTML = '<i class="check fa fa-check">✔️</i>';
    return true;
}
...
function validateBmi()
{
    ...
    {
        inputbmi.innerHTML = '<span class="wrong">✖️</i>';
        
        return false;
    }
    inputbmi.innerHTML = '<i class="check fa fa-check">✔️</i>';
    return true;
}
...
function validateGlu()
{
    ...
    {
        inputglu.innerHTML = '<span class="wrong">✖️</i>';
        return false;
    }
    inputglu.innerHTML = '<i class="check fa fa-check">✔️</i>';
    return true;
}
